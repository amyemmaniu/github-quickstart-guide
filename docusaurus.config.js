...
const config = {
  ...
  tagline: 'Getting Started With GitHub',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://amyemmaniu.github.io',
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'GitHub',
                href: 'https://github.com/amyemmaniu',
              },
            ],
          },
        ],
        copyright: `Copyright © ${new Date().getFullYear()} Amy Niu. Built with Docusaurus.`,
      },
      prism: {
